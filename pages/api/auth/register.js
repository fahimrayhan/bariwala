...
export default async function handler(req, res) {
    ...
    const { name, username, email, phone, birthdate, pass1, pass2, role, parent, nid } = req.body;
    ...
    if (!isValid) {
        ...
        if (parent) {
            ...
            VALUES('${name}', '${username}', '${email}','${phone}','${hashedPass}','${date}','${birthdate}', ${role},'0', '${parent}')`
            )
            if (results) {
